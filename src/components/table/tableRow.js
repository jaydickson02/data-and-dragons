    ...
    return (
        <>
            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                <th class="flex gap-4 px-6 py-2 font-normal text-gray-900 items-center">
                ...
                <td class="px-6 py-2">
                    <div class="flex gap-2 items-center">
                        <button class="inline-flex bg-white-500 hover:bg-gray-100 text-black dark:text-gray-400 font-bold rounded">
                            <Link href={{ pathname: '/editCharacter', query: {"ID": row.ID, "CampaignID": row.CampaignID} }}>
                                <FaEdit class="fa" size={20}/>                 
                            </Link>
                        </button>

                        <button class="inline-flex bg-white-500 hover:bg-gray-100 text-black dark:text-gray-400  font-bold px-1 rounded mb-5 mt-5 mr-5 ml-auto" onClick={() => setIsDrawerOpen(!isDrawerOpen)}>

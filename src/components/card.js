...
<div class="max-w-2xl w-full mx-auto">
    ...
    <div class="bg-white shadow-md border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        <Link href={props.link}>
            <img class="rounded-t-lg" src={props.image} alt=""></img>
        </Link>
        <div class="p-5">
            <Link href={props.link}>
                <h5 class="text-gray-900 font-bold text-2xl tracking-tight mb-2 dark:text-white">{props.title}</h5>
            </Link>
            <p class="font-normal text-gray-700 mb-3 dark:text-gray-400 h-64 overflow-scroll overflow-x-hidden">{props.description}</p>

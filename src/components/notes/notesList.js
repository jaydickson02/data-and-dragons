...
const NotesList = ({ notes, selectedNote, selectedTag, handleNoteSelect, addNewNoteToDatabase, campaignID }) => {
                ...
                <li key={note.uniqueID}>
                  <button
                    className={`block w-full text-left p-2 rounded-md dark:text-gray-100 ${
                      note.uniqueID === selectedNote?.uniqueID ? 'bg-gray-100 dark:bg-gray-600 border-l-8 border-gray-500' : ''
                    }`}
